...
def args_to_typehints(argument) -> Optional[str]:
    ...
    lookup_table = {
        ...
        "[boolean, boolean, boolean, boolean, boolean, boolean, boolean]": "Tuple[bool, bool, bool, bool, bool, bool, bool]",
...
cmd_arg_typehint_override = {
    "curve": {
        "point": ["List[Tuple[float, float, float]]", "Tuple[float, float, float]"],
        "knot": ["List[int]", "int"],
    }
}
